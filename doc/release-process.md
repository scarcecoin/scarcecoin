...
**Perform Mac build:**
  ...
  ScarceCoin 0.8.x is built with MacPorts.  0.9.x will be Homebrew only.
	...
	python2.7 contrib/macdeploy/macdeployqtplus ScarceCoin-Qt.app -add-qt-tr $T -dmg -fancy contrib/macdeploy/fancy.plist

 Build output expected: ScarceCoin-Qt.dmg
